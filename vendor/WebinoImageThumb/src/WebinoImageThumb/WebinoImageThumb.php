...
/**
 * createWatermark($right_margin, $bottom_margin) Плагин наложения водяного знака
 * @access public
 * @author Stanislav WEB | Lugansk <stanisov@gmail.com>
 * @return \PHPThumb\Plugins\GdWatermark
 */
    public function createWatermark($watermark, $right_margin, $bottom_margin)
    {
        return new Plugins\GdWatermark($watermark, $right_margin, $bottom_margin);
    }    
}
