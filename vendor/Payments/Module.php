<?php
namespace Payments; // declare namespace for the current module "Payments"
use Zend\Mvc\MvcEvent; //событийная модель MVC
use Zend\Mvc\ModuleRouteListener; //событийная модель MVC
 ...
 * @filesource /module/Payments/Module.php
 */
class Module
{
    /**
    ...
    public function getServiceConfig()
    {
        return array(
            'service_manager' => array(
                ...
                'factoires' => array(
                    'Payments\Factory\ProviderFactory'  => __NAMESPACE__.'\Factory\ProviderFactory',
                ),
            ),            
        );
    }    
