...
/**
 * Privat24 Provider. Powered by Protocol interaction with providers payment service Privat Bank.
 ...
 * @filesource /module/Payments/src/Payments/Provider/Privat24.php
 */
class Privat24 extends \ReflectionClass implements Aware\ProviderInterface {
    ...
    public function processForm(\Zend\Stdlib\Parameters $parameters)
    {
        ...
        $this->__setAdapterConfig([
                'CURLOPT_CUSTOMREQUEST'     =>  'POST',                                                          // set transaction method
        ...
        $request->setUri($this->__config['request_uri']);
