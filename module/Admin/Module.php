...
namespace Admin; // объявяю пространство имен для текущего модуля "Admin"
...
/**
 * Для наглядности, модуль обеспечивающий базовую функциональность для модуля "Admin".
 ...
 * Он будет искать этот файл в корневой директории модуля (module/Admin), который должен содержать класс Social\Module.
 ...
 * @filesource /module/Admin/Module.php
 */
class Module
{
    /**
